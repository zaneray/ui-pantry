(function () {
  ...
  var components = /*#__PURE__*/Object.freeze({
    ...
    zrAlert: zrAlert,
    zrButton: zrButton,
    zrCheckbox: zrCheckbox,
    zrCounter: zrCounter,
    zrImage: zrImage,
    zrInput: zrInput,
    zrInputWrapper: zrInputWrapper,
    zrLoading: zrLoading,
    zrPicture: zrPicture,
    zrProgress: zrProgress,
    zrRadio: zrRadio,
    zrRangeSlider: zrRangeSlider,
    zrSelect: zrSelect,
    zrVideo: zrVideo,
    zrAccordion: zrAccordion,
    zrAccordionGroup: zrAccordionGroup,
    zrHeroBanner: zrHeroBanner,
    zrIntersection: zrIntersection
  });
